...
const width = 1859;
const height = 846;
const folder = 'design-proposals/cherokee-reference';
const prefix = 'public/images/cherokee-reference';
...
const shadow = vehicleShadows.cherokee;
...
await copyFile(prefix + '-showroom.webp', prefix + '-scene.webp');
const hero = prefix + '-showroom.webp';
const crop = { left: 220, top: 146, width: 1400, height: 674 };
await sharp(hero)
  .extract(crop)
  .resize(1080, 520)
  .webp({ quality: 87 })
