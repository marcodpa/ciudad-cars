...
## Imágenes y transición vigentes de la flota

El catálogo, las miniaturas y las fichas conservan las cinco imágenes cinematográficas de la intro: Lancer, Cruze, Camry, Cherokee y Explorer. El selector deriva cinco capas transparentes de esas imágenes, conservando su apariencia fotográfica, con un único fondo de ciudad extraído de la escena del Lancer. Las sombras de contacto forman parte del canal alfa; no se usan las sombras SVG del diseño anterior.

Una sola imagen de fondo queda inmóvil durante toda la selección. La secuencia GSAP dura 1,06 s: salida con aceleración durante 0,28 s, entrada desde el otro lado durante 0,76 s con frenada suave, desenfoque breve y escala muy sutil; los datos aparecen escalonados. No hay solapamiento entre vehículos. Al invertir o pulsar varias miniaturas, la secuencia anterior se cancela y se retoma desde la capa visible. Se espera la decodificación de la nueva imagen, se cancela trabajo pendiente al desmontar y movimiento reducido cambia directamente la selección. Flechas, miniaturas, teclado y gesto horizontal siguen disponibles.

Las capas y el fondo tienen variantes WebP de 2016 × 1140 y 1008 × 570. `docs/fleet-stage.json` registra los seis edits realizados con image_gen integrado, prompts y huellas de archivos; `docs/fleet-photography.json` conserva la procedencia Higgsfield de las fotografías fuente. Son composiciones ilustrativas, no fotografías documentales de unidades disponibles. Las secciones históricas anteriores describen versiones previas.
